 ...
 */
/*
 * The Character class stores all the characters information if they wish to create a new character,
 * although not all the field are not currently being use this allows for the program to be future
 * proof for further updates
 */
